...
nivel1 = 0;
 for (int i = 0; i <10; i++) 
  ...
  tensiune = (float)vref * nivel /1024.;  // voltage on Rv
  curent = (float)(vref - tensiune)/R1;  //current thtu divider
  plutitor = (float)tensiune / curent;  // resistance of fuel sensor
